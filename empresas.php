...
<html class="ls-theme-indigo">
  ...
  <header class="ls-info-header">
    <!--icone no titulo -->
    <h2 class="ls-ico-earth">Empresas</h2>
    <a href="cadastro_empresa.php" class="ls-btn ">Adicionar empresa</a>
  </header>
...
<table  class="ls-table ls-table-striped display" id="tabela" style="width:100%">
  <thead>
    ...
    <tr>
      ...
      <th class="hidden-xs ls-data-descending">Responsável</th>
  ...
  <tbody>
    ...
    <tr>
      ...
      <td class="hidden-xs"><?=$linha['responsavel']?></td>
      <td>

        <form action="editar_empresa.php" method="POST" enctype="multiparty/form-data">
        <input type="hidden" name="idEmpresa" id="idEmpresa" value=<?=$linha['idEmpresa']?>>
        <button type="submit" class="ls-btnr ls-ico-pencil espacobtn" title="Alterar"></button>
        </form>
        <form action="include/Dempresa.php" method="POST" enctype="multiparty/form-data">
        <input type="hidden" name="idEmpresa" id="idEmpresa" value=<?=$linha['idEmpresa']?>>
