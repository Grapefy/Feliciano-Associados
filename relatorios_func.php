  ...
  <tbody>
    ...
    <tr>
      ...
      <td>
        ...
        <?php 
        if($_SESSION['tipoCliente'] == 1 or $_SESSION['tipoCliente'] == 2){?>
        <input type="hidden" name="ind_visualizado" id="ind_visualizado" value="S">
        <?php } ?>
        
         <?php 
        if($_SESSION['tipoCliente'] == 3 or $_SESSION['tipoCliente'] == 4){?>
        <input type="hidden" name="ind_visualizado" id="ind_visualizado" value=<?=$linha['ind_visualizado']?>>
        <?php } ?>
