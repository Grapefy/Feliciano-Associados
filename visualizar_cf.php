...
$total = mysqli_num_rows($dados);
  ...
  <form action="" class="ls-form ls-form-text ls-form ls-form-disable" data-ls-module="form">
    ...
    <label class="ls-label col-md-3">
      ...
      <input type="text" name="" id="nome" value="<?php echo $linha['nome'] . " " . $linha['sobrenome']?>">
    </label>
    
    <label class="ls-label col-md-3">
      <b class="ls-label-text">Data de Nascimento:</b>      
      <input type="text" name="dataNasc" id="dataNasc" value=<?=date("d/m/Y",strtotime(str_replace('-','/',$linha["dataNascimento"])));?>>
    </label>
    ...
    <a href="clientefisico.php"><button class="ls-btn ls-ico-chevron-left">Voltar</a>
    </main>
