...
$total = mysqli_num_rows($dados);
  ...
  <form action="include/Urelcliente.php" method="post" class="ls-form-horizontal" data-ls-module="form">
  <fieldset id="fields-disabled" class="row ls-form-disable ls-form-text">
    ...
    <input type="hidden" name="idRelatorioCliente" value=<?=$linha['idRelatorioCliente']?>>
